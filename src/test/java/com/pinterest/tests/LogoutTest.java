...
public class LogoutTest extends BaseTest {
    ...
    public void validLogout() {
        ...
        test.info("Redirected to Pinterest homepage after logout");
        ...
        test.info("=== Logout Test Completed ===");
